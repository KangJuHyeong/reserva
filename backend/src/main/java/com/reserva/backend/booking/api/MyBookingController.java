...
public class MyBookingController {
    ...
    public PageResponse<BookingSummaryResponse> getMyBookings(
        ...
        return bookingQueryService.getMyBookings(status, page, size);
    }

    @GetMapping("/{bookingId}")
    public BookingDetailResponse getMyBookingDetail(@PathVariable String bookingId) {
        return bookingQueryService.getMyBookingDetail(bookingId);
    }
}
